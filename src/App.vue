<template>
  <div>
    ...
    <div
      ...
      class="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-3"
    >
      <p class="text-sm font-semibold text-slate-700 tracking-tight">WorshipPlanner</p>
