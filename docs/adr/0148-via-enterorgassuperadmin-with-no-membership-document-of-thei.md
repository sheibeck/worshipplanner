# 0148. Via enterOrgAsSuperAdmin, with NO membership document of their own
...
This rationale is applied at 2 call site(s) within `src/stores/auth.ts`. No external review/research document is cited for this decision — it was a file-local judgment call.

via enterOrgAsSuperAdmin, with NO membership document of their own. Null means no such visit is in effect.
