# 0124. This listener ONLY updates isFullscreen. It must NEVER call any
...
This listener ONLY updates isFullscreen. It must NEVER call any exit/teardown/ close/unmount path — the single most dangerous copy-paste risk from PresentationViewer.handleFullscreenChange (Pitfall 6).

## Decision

The rationale below is preserved verbatim from the source comment(s) it was extracted from (tag: `Pitfall`):

**`src/composables/useOutputWindow.ts:102-105`:**
