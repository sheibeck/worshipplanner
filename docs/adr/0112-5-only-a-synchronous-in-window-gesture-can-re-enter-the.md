# 0112. 5 — only a synchronous in-window gesture can re-enter; the
...
This rationale is applied at 2 call site(s) within `src/composables/useOutputWindow.ts`. No external review/research document is cited for this decision — it was a file-local judgment call.
