# 0027. (Google-managed, no DNS access). fromDisplayName + bareEmailAddress
...
This rationale is applied at 2 call site(s) within `functions/src/index.ts`. Documented at the time in `59-RESEARCH.md`.
...
**`functions/src/index.ts:2810-2816`:**
