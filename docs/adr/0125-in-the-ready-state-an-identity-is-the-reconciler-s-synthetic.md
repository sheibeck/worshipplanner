# 0125. In the ready state an identity is the reconciler's synthetic
...
This rationale is applied consistently at 3 call site(s) across 3 files: `src/composables/useSlideshowAssembly.ts`, `src/utils/importedRenderReconciler.ts`, `src/utils/slideGroupMaterializer.ts`. Documented at the time in `42-RESEARCH.md`.
