# 0030. Never stranded (R290, R291). The onboarding.emailsEnabled owner
...
This rationale is applied at 2 call site(s) within `functions/src/inviteOnboarding.ts`. No external review/research document is cited for this decision — it was a file-local judgment call.
