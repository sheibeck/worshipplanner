...
<tasks>
- [x] **T01**: Added ScriptureSlide type, ScriptureReading type, and splitPassage utility with 10 passing tests _(M)_
...
- [x] **T02**: Added useScriptureSlides Pinia store with Firestore CRUD, real-time subscription, and 15 passing tests _(M)_
...
- [x] **T03**: Added ScriptureSlideEditor component with ESV fetch, auto-split preview, manual slide override, and auto-save integration — 15 passing tests _(L)_
...
- [x] **T04**: Added CongregationalEditor component with Leader/Congregation speaker role assignment, alternating default pattern, preview panel, and auto-save — 15 passing tests _(L)_
...
- [x] **T05**: Wired ScriptureSlideEditor and CongregationalEditor into ServiceEditorView with reading mode toggle and 16 passing integration tests _(M)_
