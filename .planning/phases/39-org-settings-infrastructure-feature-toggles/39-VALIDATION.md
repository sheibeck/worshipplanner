...
| R088 | Three AI entry points hide when `aiEnabled` is false (UI consequence, not the enforcement) | component | `CongregationalEditor.test.ts`, `ScriptureSlideEditor.test.ts` | ✅ extend |
