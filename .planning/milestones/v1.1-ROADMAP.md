# Roadmap Archive: v1.1 (Phases 8-17, 16.1)

**Shipped:** 2026-07-24 · **Archived:** 2026-07-28

Extracted from the active `.planning/ROADMAP.md` so shipped phases stop being reported as
incomplete by phase discovery. Phase artifacts live in `milestones/v1.1-phases/`.
