...
# Phase 24 — Slide Group Model and Migration: Verification
...
| Evidence | Location |
|---|---|
| Per-plan summaries | `24-*-SUMMARY.md` |
| Code review + fixes | `24-REVIEW.md` / `24-REVIEW-FIX.md` |
...
Persisted `SlideGroup` model owned by service plan items; stable `ServiceSlot.id`; group structure materialized while song/scripture text stays a live reference; plan-item delete cascades behind a warning; Phase 22 slot-level media replaced by group bed + per-slide audio.
