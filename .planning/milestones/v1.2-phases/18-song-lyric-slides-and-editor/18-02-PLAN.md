...
# Plan 18-02: Auto-Save Composable Extraction
...
Note: Do NOT refactor ServiceEditorView to use this composable in this plan.
...
Create `.planning/phases/18-song-lyric-slides-and-editor/18-02-SUMMARY.md` when done.
