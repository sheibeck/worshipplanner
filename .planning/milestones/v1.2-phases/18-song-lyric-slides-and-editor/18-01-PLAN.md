...
# Plan 18-01: CCLI Paste Parser and Core Types
...
1. Create src/types/slide.ts with the unified Slide type:
   - contentKind discriminator field ('lyric' initially, 'scripture'/'imported' in later phases)
...
Create `.planning/phases/18-song-lyric-slides-and-editor/18-01-SUMMARY.md` when done.
