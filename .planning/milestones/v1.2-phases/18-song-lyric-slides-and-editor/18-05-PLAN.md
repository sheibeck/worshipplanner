...
# Plan 18-05: Song Lyric Editor with Auto-Save and Copyright Display
...
1. Create src/components/SongLyricEditor.vue:
   ...
   - Auto-save integration using useAutoSave composable (from 18-02):
   ...
   - "Paste New Lyrics" button opens LyricPasteDialog (from 18-04) to re-import/overwrite
...
Create `.planning/phases/18-song-lyric-slides-and-editor/18-05-SUMMARY.md` when done.
