...
# Plan 18-07: Version History UI and SongSlideOver Lyrics Tab Integration
...
2. Modify src/components/SongSlideOver.vue to add a tabbed interface:
   ...
   - "Lyrics" tab: contains SongLyricEditor (18-05), PerformanceOrderBuilder (18-06), and LyricVersionHistory
...
Create `.planning/phases/18-song-lyric-slides-and-editor/18-07-SUMMARY.md` when done.
