...
**Plans**: 2 plans
- [ ] 92-01-PLAN.md — Build + wire the Monitor Setup screen (route, gated nav entry, MonitorSetupView + MonitorCard + MonitorFallbackPanel; state machine, synchronous detection, device-scoped persistence with save round-trip check)
