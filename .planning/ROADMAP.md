...
Plans:
- [ ] 127-01-PLAN.md — Extend the rehearseAccess projection (orderOfService/roleAssignments/stageLayout/bpm) via a shared PII-safe allowlist; lock-time write; no rules change (R385/R386/R392/R393)
- [ ] 127-02-PLAN.md — Rehearse song list + song detail (key/counts/now-playing; PDFs Print+Download, recordings Play+Download, external links) (R385/R386/R390)
- [ ] 127-03-PLAN.md — PDF reader (native iframe desktop / link-first mobile) + single persistent native audio player (speed/loop/seek) (R387/R388/R389/R391)
