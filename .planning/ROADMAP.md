...
- [ ] 118-01-PLAN.md — firestore.rules hardening + rules tests: draft-provenance guard (R341), orgSlugs/orgNames get/list split (R343), super-admin members-write document+pin (R342), admin/editor synonymity document+pin (R348) [wave 1]
