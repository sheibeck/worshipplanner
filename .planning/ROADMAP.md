...
**Plans**: 2 plans
- [ ] 89-01-PLAN.md — R259: rename `Role.vocal`→`Role.multiRole`, rewrite `evaluateGroupCombo` (filter-multi-first, cross-type), read-time compat shim, generalized RoleSlideOver "Multi-role" control + helper text, badges/warn, all fixtures (Wave 1)
