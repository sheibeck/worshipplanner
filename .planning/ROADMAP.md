...
**Plans**: 2 plans
- [ ] 130-01-PLAN.md — Thread `orgName` through the rehearseAccess projection (both write paths) + add distinct-church derivation and a client-side filter to the mySchedule store (wave 1)
