...
Last activity: 2026-08-09 — Completed quick task 260809-vvq: Planning Center export fixes (NLT scripture routing + empty-ref 400 fix, export all slot types, passage-only plan title)
